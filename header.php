	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( is_front_page() && is_home() ) :
				...
				<h1 class="site-title">	<img src="wp-content/uploads/LogoTimSiteE.png" class="titre1" style="background-size:30px;"> </img><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
